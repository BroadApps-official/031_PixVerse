...
protocol RateSettingsViewDelegate: AnyObject {
    func didTapRateView()
}

final class RateSettingsView: UIControl {
    weak var delegate: RateSettingsViewDelegate?
    ...
    init(delegate: RateSettingsViewDelegate) {
    ...
    private func drawSelf() {
        ...
        typeImageView.image = UIImage(named: "set_rate_icon")
